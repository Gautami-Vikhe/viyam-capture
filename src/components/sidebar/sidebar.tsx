      ...
      <div className="sidebar-logo">
        <div>
          ...
          <Link to={route.dashboard} className="logo logo-normal">
            <img src="/src/assets/img/VMlogo.png" alt="Viyam Capture" style={{ width: "140px" }} />
          </Link>
          {/* Logo Small */}
          <Link to={route.dashboard} className="logo-small">
            <img src="/src/assets/img/VMlogo.png" alt="Viyam Capture" style={{ width: "40px" }} />
          </Link>
          {/* Logo Dark */}
                      ...
                      return (
                          ...
                          >
                            ...
                            {title.label === "Changelog" && (
                              <span className="badge badge-sm bg-success fs-12" style={{ marginLeft: 8 }}>v1.0.7</span>
                            )}
                            {title?.count && (
