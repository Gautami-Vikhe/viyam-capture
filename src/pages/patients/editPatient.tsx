...
const EditPatient = () => {
  ...
  // Age state - calculated automatically from DOB
  ...
  // Calculate age from a DOB Date object
  ...
  // Called whenever the DOB date picker value changes (CommonDatePicker uses Dayjs)
  const handleDobChange = (date: Dayjs,) => {
    if (date) {
      setAge(calculateAge(date.toDate()));
    } else {
      setAge("");
    }
  };
                  ...
                  <form>
                    <div className="card mb-0">
                      <div className="card-body p-4">
                        ...
                        <div className="pt-4 mt-3 border-top medication-list">
                          <div className="row medication-list-item g-3">
                            <div className="col-xl-3 col-md-6">
                              <label className="form-label">Type</label>
                              <CommonSelect
                                options={Type}
